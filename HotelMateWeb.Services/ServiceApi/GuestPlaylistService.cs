...
namespace HotelMateWeb.Services.ServiceApi
{
    ...
    public class GuestPlaylistService : IGuestPlaylistService
    {
        private UnitOfWork _unitOfWork = new UnitOfWork();

        public IList<GuestPlaylist> GetAllInclude(string includeProperties)
        {
            return _unitOfWork.GuestPlaylistRepository.GetByQuery(null, null, includeProperties).ToList();
        }
        ...
        public GuestPlaylist Update(GuestPlaylist existingGpl, List<Movie> selectedVideos)
        {
            ...
            var newGPL = new GuestPlaylist { Description = existingGpl.Description, GuestId = existingGpl.GuestId, Name = existingGpl.Name, DateCreated = DateTime.Now };
