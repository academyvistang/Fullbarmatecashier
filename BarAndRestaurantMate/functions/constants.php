...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'hotelmotel');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'HotelMotel');

// Set the URL of the online documentation here. Appears on top of the discounthotelmotels Settings panel as "Documentation".
// You can set it to an empty string if you want to remove the "Documentation" link.
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://discounthotelmotels.com/support/viewtopic.php?f=54&t=14725');

// Set the URL of the online support forum. Appears on top of the discounthotelmotels Settings panel as "Support forum".
// You can set it to an empty string if you want to remove the "Support forum" link.
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://discounthotelmotels.com/support/viewforum.php?f=54');

// Set the following to true, if you want to remove any discounthotelmotels traces.
...
// Update checks occur once per day, and if an update is available, a message appears on top of the discounthotelmotels Settings panel.
