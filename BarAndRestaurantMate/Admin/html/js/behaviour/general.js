var App = function () {
  ...
  [23, 75 + randValue()]
            ...
            $.ajax({
                ...
                {                    
                    PlotMyGraphOh(data, visitors);
                }
            });
        }

        function PlotMyGraphOh(pageviews, visitors)
        {
            ...
            if ($('#site_statistics').size() != 0) {
                ...
                /*Pie Chart*/
                var data = [
                { label: "Excellent", data: 50 },
                { label: "Very Good", data: 7 },
                { label: "Good", data: 8 },
                { label: "Average", data: 9 },
                { label: "Bad", data: 14 },
                { label: "Very Bad", data: 13 },
                { label: "Very Very Bad", data: 10 },
                { label: "Disaster", data: 5 }
                ];
    ...
    return {
        ...
        init: function (options) {
            ...
            $(".cl-vnavigation li").hover(function (e) {
                if (($("#cl-wrapper").hasClass("sb-collapsed") || ($(window).width() > 768 && $(window).width() < 963)) && $("ul", this).length > 0) {
                    $(this).removeClass("ocult");
                    var menu = $("ul", this);
                    if (!$(".dropdown-header", this).length) {
                        var head = '<li class="dropdown-header">' + $(this).children().html() + "</li>";
                        menu.prepend(head);
                    }

                    tool.appendTo("body");
                    var top = ($(this).offset().top + 8) - $(window).scrollTop();
                    var left = $(this).width();
            ...
            $(".cl-vnavigation li").click(function (e) {
                if ((($("#cl-wrapper").hasClass("sb-collapsed") || ($(window).width() > 768 && $(window).width() < 963)) && $("ul", this).length > 0) && !($(window).width() < 755)) {
                    e.stopPropagation();
                }
            });
