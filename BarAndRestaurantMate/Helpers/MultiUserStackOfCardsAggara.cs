...
{
    public class MultiUserStackOfCardsAggara
    {
        private List<Card> computersStack = null;
        private List<Card> homePageStack = null;
        private List<User> usersList = null;

        public MultiUserStackOfCardsAggara(List<Card> Cards, List<Card> AllPlayingCards, GameUser[] gameUsers)
        {
            int numOfUsers = gameUsers.Length;

            int CutOff = 5 * numOfUsers;
        ...
        public MultiUserStackOfCardsAggara(List<Card> Cards, List<Card> AllPlayingCards, int numOfUsers)
        {
