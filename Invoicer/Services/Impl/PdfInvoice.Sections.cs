...
namespace Invoicer.Services.Impl
{
    public partial class PdfInvoice
    {
        private void HeaderSection()
        {
            ...
            {
                //System.Drawing.Bitmap image1 = (System.Drawing.Bitmap)System.Drawing.Image.FromFile(@"", true);
        ...
        private void BillingSection(int checkout = 0)
        {
            Section section = Pdf.LastSection;
        ...
        private void BillingHeaderCheckout(Table table)
        {
            Row row = table.AddRow();
            ...
            row.Cells[0].AddParagraph("DATE", ParagraphAlignment.Left);
            row.Cells[1].AddParagraph("QUANTITY", ParagraphAlignment.Center);
        ...
        private void BillingHeader(Table table)
        {
            ...
            row.Cells[0].AddParagraph("TIME", ParagraphAlignment.Left);
            row.Cells[1].AddParagraph("DETAILS", ParagraphAlignment.Center);
            row.Cells[2].AddParagraph("QUANTITY", ParagraphAlignment.Center);
            row.Cells[3].AddParagraph("UNIT PRICE", ParagraphAlignment.Center);
            row.Cells[4].AddParagraph("TOTAL", ParagraphAlignment.Center);
        }

        private void BillingRowCheckout(Table table, ItemRow item)
        {
            var strCurrency = Invoice.Currency.ToString();
            ...
            cell.AddParagraph(item.TransactionDate.ToShortTimeString(), ParagraphAlignment.Left, "H2-9B");
            cell.AddParagraph(item.Description, ParagraphAlignment.Left, "H2-9-Grey");

            cell = row.Cells[1];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.Quantity.ToString(), ParagraphAlignment.Center, "H2-9");

            cell = row.Cells[2];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.UnitPrice.ToCurrency(), ParagraphAlignment.Center, "H2-9");

            cell = row.Cells[3];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.TotalPrice.ToCurrency(strCurrency), ParagraphAlignment.Center, "H2-9");

            //cell = row.Cells[4];
            //cell.VerticalAlignment = VerticalAlignment.Center;
            //cell.AddParagraph(item.Total.ToCurrency(strCurrency), ParagraphAlignment.Center, "H2-9");
        }
        ...
        private void BillingRow(Table table, ItemRow item)
        {
            ...
            cell = row.Cells[1];
            cell.VerticalAlignment = VerticalAlignment.Center;
            cell.AddParagraph(item.Description.ToString(), ParagraphAlignment.Center, "H2-9");
